...
\parbox{380pt}{\color{darkgrey}A developer with a love of open source, UI/UX, and taking deep dives into subjects. Latest interests are figuring out how to derive value from LLMs, Rust, deep type systems, and retrocomputing preservation.}
...
\begin{itemize}
    ...
    \item Device reverse engineering 
    \item Frequent contributor to large OSS projects (e.g. Playwright, added Vision Pro to Rust compiler)
...
\begin{itemize}
    \item Create - Designer - PowerPoint
    \item One of six developers on Microsoft Playwright, the premiere browser testing tool
...
\begin{itemize}
    \item Founding engineer building the highly used Azure Data Explorer Dashboards in React + TypeScript
